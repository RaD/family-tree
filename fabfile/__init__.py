                ...
                'exclude': ' '.join(
                    map(
                        ...
                        ['.git/', '.gitignore', '*.sql', '*.sh', '*.rst', '*.po', '*.pyc', '*.sqlite', '*template',
                         'cache/', 'env/', 'fabfile/', 'logs/', 'meandre/', 'precise/', 'sshfs/', 'tmp/',
                         'src/public/', 'src/legacy', 'src/search/xapian_index', 'src/search/xapian_index_test',
                         'wsgi.py', 'settings_dump.py', 'test_settings.py',
                         'local_settings.py', 'prod1_settings.py', 'prod2_settings.py'
                         ])),
                'src': '.',
                'target': target
            })
